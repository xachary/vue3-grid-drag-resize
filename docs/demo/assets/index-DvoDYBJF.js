    ...
    watchEffect(() => {
      if (props.columnStart !== void 0) {
        if (props.columnEnd === void 0 || props.columnEnd < props.columnStart) {
          emit2("update:columnEnd", props.columnStart + 1);
        }
      } else {
        emit2("update:columnStart", 1);
      }
      if (props.rowStart !== void 0) {
        if (props.rowEnd === void 0 || props.rowEnd < props.rowStart) {
          emit2("update:rowEnd", props.rowStart + 1);
        }
      } else {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(childrenParsed.value, (child, idx) => {
          return openBlock(), createBlock(_sfc_main$2, mergeProps({ key: idx }, child, {
            ...
            "column-end": child.columnEnd,
            "onUpdate:columnEnd": ($event) => child.columnEnd = $event,
...
const logArray = (words) => {
  try {
    ...
    if (Array.isArray(words)) {
      ...
      console[type](format, ...array);
    }
  } catch (e) {
    console.error(e);
  }
};
var define_BUILD_INFO_default = { lastBuildTime: "2024-10-14 19:08:18", git: { branch: "master", hash: "65a9f1724174d0c197913fbc9d2693619a86b296", tag: "65a9f1724174d0c197913fbc9d2693619a86b296-dirty" } };
const {
  lastBuildTime,
  git: { branch, tag, hash }
